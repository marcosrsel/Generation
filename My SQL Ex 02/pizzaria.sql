...
doce varchar(255),
salgada varchar(255),
salgada_pan varchar(255),
meia_a_meia varchar(255),
class_id bigint,
...
values("4 queijos", 50.00, "media"),
("Calacatu", 45.00, "grande"),
("Caramelo", 55.00, "grande"),
("Marguerita", 40.00, "pequena");
...
insert tb_pizzas(salgada_pan,class_id)
values ("Sim", 1);

insert tb_pizzas(salgada,class_id)
values ("Sim",4);

insert tb_pizzas(meia_a_meia,class_id)
values ("Sim", 1);
